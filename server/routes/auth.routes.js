...
import { login, signup, logout, refreshToken, verifyEmail } from '../controllers/auth.controller.js';
import { loginValidation, signupValidation, verifyEmailValidation } from '../config/validation/auth.validation.js';
